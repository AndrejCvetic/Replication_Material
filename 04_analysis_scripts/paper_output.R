...
# save the figure from R Studio Viewer

###################################
### FIGURE 2, panel (a) (P. 19) ###
###################################
...
#mlogitresult3
#Identifying Asian/Black relative to British 
yhype5p <- c(0.00172764, -0.1505670) 
yhype5l<- c(-0.0892326, -0.18932326)
yhype5u<- c(0.1184218, -0.09020152)

#Identifying Both Relative to Asian/Black
yhype6p <- c(-0.23390784, -0.1058980) 
yhype6l<- c(-0.3369534, -0.25872035)
yhype6u<- c(-0.1173125, 0.06029737)
...
tc_nl_scip_1<-tile(trace3, trace4,
                   ...
                   topaxis=list(at1 = at.x1, 
                                ...
                                cex=.8,
                                add = rep(TRUE,2)),
                   topaxistitle = list(labels=c("Ethnic Based Engagement (Specific Measures): NL"), cex=1),
                   undertitle = list(labels="Change in Predicted Probability (Min-Max)", cex=.7, x=1),
...
tc_uk_scip_4<-tile(trace7,
                   ...
                   output = list(file = "fig6_pau", width=12, type="pdf"), 
                   frame=FALSE,
                   gridlines=list(type="x", col="grey65")
)
...
tc_uk1_scip_5<-tile(trace9,
                    ...
                    topaxistitle = list(labels1= "Neutral to Disagreement", 
                                        labels2= "Agreement to Disagreement"),
                    output = list(file = "fig6_pal", width=12, type="pdf"), 
                    frame=FALSE,
                    gridlines=list(type="x", col="grey65")
)
...
tc_nl_scip_4<-tile(trace7,
                   ...
                   undertitle = list(labels="Change in Predicted Probability (Min-Max)", cex=.7, x=1),
                   plottitle= list(label=c("Inconcievable values (Specific Measures): NL)"), cex=1),
                   output = list(file = "fig6_pbu", width=12, type="pdf"), 
                   frame=FALSE,
                   gridlines=list(type="x", col="grey65")
)
...
tc_nl_scip_5<-tile(trace9,
                   ...
                   topaxistitle = list(labels1= "Neutral to Disagreement", 
                                       labels2= "Agreement to Disagreement"),
                   output = list(file = "fig6_pbl", width=12, type="pdf"), 
                   frame=FALSE,
                   gridlines=list(type="x", col="grey65")
)

toc()
# 352.439 sec elapsed = 5.873983 min. to execute the code.
